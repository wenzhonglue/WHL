...
c      rad=0.5*(ez(1.)/ez(az2(3)))**0.333
     ...
     $           abs(az2(2)-z1(i,2))**2
            ...
            if(z6.le.rad.and.zmass2.ge.1..and.
     $           z1(i,4).ge.az2(4)-0.25)then
               M=M+1
               sum=sum+zmass2
            endif
c     -----------------------------------------
            if(z6.le.0.5.and.zmass2.ge.1..and.
     $           z1(i,4).ge.az2(4)-0.25)then
               M2=M2+1
               sum2=sum2+zmass2
            endif
...
c     -----------------------------------------
      ...
      enddo
      rich=sum-az2(9)*rad**2
      rich2=sum2-az2(9)*0.25
      if(rich.ge.4.)then
         tmp=0.402*log10(rich)-0.944-0.43*log10(1+az2(3))
         r500=10**tmp
      endif
      if(r500.ge.0.435*rad)then
         write(30,100)id2,(az2(j),j=1,6),r500,rich,rich2,az2(9),M,ip2(2)
      endif
      goto 33
 44   close(20)
      ...
      goto 15
 16   close(12)
 100  format(I7,2F11.5,F8.4,2F7.3,F7.2,F6.3,2F8.2,F7.2,2I4)
      end
c     id,ra,dec,z,i_bcg,w1_bcg,stamass_bcg,r500,lum05e,lum05,flat,N5e
